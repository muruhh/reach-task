				...
				<div
					className={
						videos.id.kind == "youtube#video"
							? "list__item item__video"
							: "list__item item__channel"
					}
					key={videos.etag}
				>
					<div className="list__thumbnail">
						<a
							...
							href={
								videos.id.kind == "youtube#video"
									? `https://www.youtube.com/watch?v=${videos.id.videoId}`
									: `https://www.youtube.com/channel/${videos.id.channelId}`
							}
						>
							<img
								className="list__img"
					...
					<div className="list__contents">
						...
						{videos.id.kind == "youtube#video" && (
							<span className="list__channel-title">
								<a
									className="list__link"
